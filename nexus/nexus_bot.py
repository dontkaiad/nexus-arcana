...
async def cmd_help(msg: Message, user_notion_id: str = "") -> None:
    await msg.answer(
        ...
        "📊 <b>БЮДЖЕТ</b>\n"
        "Полная картина: доход, обязательные, свободные, долги, цели.\n"
        "Первый запуск <code>/budget</code> — пошаговый wizard:\n"
        "  1️⃣ Выбери обязательные траты (жилье, коты, подписки...)\n"
        "  2️⃣ Добавь цели (телефон, ПК, подушка — всё сразу)\n"
        "  3️⃣ Добавь долги (всех сразу, каждый с новой строки)\n"
        "  4️⃣ Покажу бюджет + совет от AI + предложу лимиты\n"
        "После каждой траты — остаток свободных и ₽/день.\n"
        "При получении зарплаты — автоматически покажу бюджет.\n"
        "Обязательные: «обязательный расход квартира 25000».\n"
        "Лимиты: «лимит на кафе 5000р» — предупрежу при 80% и 100%.\n"
        "Цели: «цель телефон 100000».\n"
        "Долги: «долг подружке 50000 до апреля».\n"
        "Изменить: «измени обязательный квартира на 26000».\n"
        "Убрать: «убери обязательный расход интернет».\n"
