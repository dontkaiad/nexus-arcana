...
BUDGET_SONNET_SYSTEM = (
    ...
    "  - Пример: *** 50к (дедлайн апрель), платим в апреле → 1 мес → 50к/мес\n"
    "    *** 100к (дедлайн август), платим с МАЯ (после ***) → 4 мес → 25к/мес\n"
    "    *** 40к (дедлайн сентябрь), платим с МАЯ → 5 мес → 8к/мес\n"
