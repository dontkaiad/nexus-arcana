...
2. Фиксированные траты (ж***, коммуналка, подписки, интернет, вода, коты — НЕЛЬЗЯ сократить)
...
{{
  ...
  "income_total": 115000,
  "fixed": [
    {{"name": "Съём квартиры", "category": "🏠 Ж***", "amount": 20000}},
  ...
  "debts": [
    {{"name": "***", "amount": 50000, "deadline": "апрель 2026", "monthly": 50000, "note": "разом с ЗП", "priority": 1}}
  ],
  "debts_total": 190000,
  "goals": [
