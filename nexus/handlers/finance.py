...
_BUDGET_PARSE_PROMPT_LEGACY = """Финансовый советник. Пользователь с СДВГ (женский род).
...
{{
  ...
  "income_total": 115000,
  "fixed": [{{"name": "Съём", "category": "🏠 Ж***", "amount": 20000}}],
  "fixed_total": 54200,
  "distributable": 62716,
  "debts_monthly": [{{"name": "***", "total": 50000, "deadline": "апрель 2026", "monthly": 50000, "months_left": 1}}],
  ...
  "variant_b": {{"label": "25к сейчас + 25к в мае", "debt_payment": 25000, "remaining": 37716,
    ...
    "creditor_script": "***, могу 25к сейчас и 25к в мае — ок?",
    "relief": "Долг закроется в мае"}},
  "savings": null,
  "limits": null,
  "limits_total": null,
  ...
  "relief_timeline": "Апрель: -50к ***. Сентябрь: все долги закрыты → копим.",
