...
_TIP_SYSTEM = (
    ...
    "нейтральная лексика.\n"
    "НЕ придумывай относительные дни (\"завтра\", \"послезавтра\", "
    "\"на выходных\") для обоснования срочности — если срок задачи сегодня, "
    "объясняй важность через СЕГОДНЯ (что будет сегодня вечером/дальше по "
    "дню), а не выдуманным \"завтра\", которое не имеет отношения к её сроку.\n"
    "Примеры качества:\n"
    ...
    "(врёт про срочность)\n"
    "ПЛОХО: «Упакуй роутер сейчас, чтобы не искать его завтра» когда срок "
    "задачи СЕГОДНЯ (при чём тут завтра? срок сегодня, а не завтра)"
)
