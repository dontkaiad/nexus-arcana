...
const NexusLogo = () => (
  <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
    ...
    <svg width="130" height="56" viewBox="0 0 130 56" xmlns="http://www.w3.org/2000/svg">
      <text x="0" y="40" fontFamily="Satisfy, cursive" fontSize="44" fill="#0a2e22" stroke="#ffffff" strokeWidth="0.5" filter="drop-shadow(0px 2px 4px rgba(0,0,0,0.35))">Nexus</text>
    </svg>
  </div>
);
