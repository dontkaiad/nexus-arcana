...
PARSE_SESSION_SYSTEM = (
    ...
    "'{Имя клиента} — {Тема}' "
    "(пр.: 'клиентка оля расклад после приворота' → 'Оля — приворот'; "
    "'Маша диагностика порчи' → 'Маша — диагностика')\n"
    ...
    "→ 'Сфера жизни'\n"
    "- имя человека ('Вадим', 'Маша') без магических маркеров → 'Сфера жизни'\n"
...
PERSONAL_INTERP_SYSTEM = (
    ...
    "2. Разверни акцент в связный абзац, ОПИРАЯСЬ на РЕАЛЬНОЕ значение карты из "
    "справочника колоды (даётся ниже в «--- СПРАВОЧНИК КАРТ ---»), в контексте "
    "вопроса расклада и соседних карт.\n"
    "3. ЗАПРЕТ ГАЛЛЮЦИНАЦИЙ: НЕ вводи смысл, которого нет НИ в значении карты "
    "(справочник), НИ в акценте Кай. Справочник — опора против выдумки; акцент "
    ...
    "5. Карты нет в справочнике — разворачивай ТОЛЬКО по акценту Кай, не доизобретая.\n"
