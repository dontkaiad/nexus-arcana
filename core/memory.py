...
_PARSE_SYSTEM = (
    ...
    '  "обязательный расход квартира 25000" → {"fact":"обязательно: 🏠 Ж*** — 25000₽/мес","category":"💰 Лимит","связь":"ж***","ключ":"обязательно_ж***"}\n'
    ...
    '  "измени обязательный квартира на 26000" → {"fact":"обязательно: 🏠 Ж*** — 26000₽/мес","category":"💰 Лимит","связь":"ж***","ключ":"обязательно_ж***"}\n'
