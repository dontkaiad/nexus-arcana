...
# работает ТОЛЬКО для городов на согласную, где падежные окончания
# ДОБАВЛЯЮТСЯ к форме именительного падежа, напр. "минск"→"минске"). Для
# городов на -а/-я/-ь (москва, уфа, тула, пермь, тюмень, казань, ...)
# падежное окончание ЗАМЕНЯЕТ последнюю букву, а не добавляется к ней —
# "уфа" НЕ substring "уфе" — так что именительный падеж как единственный ключ
# ломает самую естественную фразу "я в X". Добавляй явно словоформу(ы), в
# которых юзер реально это пишет ("в X-е"/"в X-и"), как уже сделано для
# турецких городов ниже — не полагайся на префиксное совпадение для таких
# городов (issue: "я в уфе" в 1:00 не резолвился, offset уезжал на Haiku-
# фоллбэк, а matched_city оставался None — город в память не попадал).
...
CITY_TZ: Dict[str, int] = {
    ...
    "уфа": 5, "уфе": 5, "уфы": 5, "уфу": 5,
    "челябинск": 5, "тюмень": 5, "тюмени": 5,
    "башкирия": 5, "башкирии": 5, "пермь": 5, "перми": 5,
    "омск": 6,
    ...
    "сахалин": 11, "камчатка": 12, "камчатке": 12,
    # Россия — европейская часть (UTC+3) и Урал, расширение #170
    "краснодар": 3, "сочи": 3, "ростов": 3, "воронеж": 3, "волгоград": 3,
    "казань": 3, "казани": 3, "нижний новгород": 3, "новгород": 3,
    "ярославль": 3, "ярославле": 3,
    "тула": 3, "туле": 3, "мурманск": 3, "архангельск": 3, "сургут": 5, "ноябрьск": 5,
    # Другие
    "дубай": 4, "абу-даби": 4,
    "берлин": 1, "варшава": 1, "варшаве": 1, "рим": 1, "париж": 1,
    ...
    "турци": 3, "стамбул": 3, "анкара": 3, "анкаре": 3,
