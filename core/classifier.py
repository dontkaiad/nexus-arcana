...
def build_system(tz_offset: int = 3) -> str:
    ...
    return "\n".join([
        ...
        '{"type":"task","title":"что сделать","category":"<из кат>","priority":"Высокий|Средний|Низкий","deadline":"YYYY-MM-DD или YYYY-MM-DDTHH:MM или null","repeat":"Нет|Ежедневно|Еженедельно|Ежемесячно","day_of_week":"Пн|Вт|Ср|Чт|Пт|Сб|Вс или null","repeat_time":"HH:MM или null","confidence":"high если есть дата, low если даты нет"}',
        "",
