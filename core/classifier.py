...
def build_system(tz_offset: int = 3) -> str:
    ...
    return "\n".join([
        ...
        '  Ответ: {"type":"task","title":"зарядить наушники","category":"🏠 Ж***","priority":"Можно потом","deadline":"' + _next_weekday_iso("Вс") + '","repeat":"Нет","repeat_time":null,"day_of_week":null,"confidence":"high"}',
