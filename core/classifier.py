...
def build_system(tz_offset: int = 3) -> str:
    ...
    return "\n".join([
        ...
        'Вход: "написать Маше" → {"type":"task","title":"написать Маше","category":"👥 Люди","priority":"Средний","deadline":null,"repeat":"Нет","repeat_time":null,"day_of_week":null,"confidence":"high"}',
        'Вход: "позвонить Руслану" → {"type":"task","title":"позвонить Руслану","category":"👥 Люди","priority":"Средний","deadline":null,"repeat":"Нет","repeat_time":null,"day_of_week":null,"confidence":"high"}',
        "",
