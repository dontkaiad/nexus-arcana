...
def build_system(tz_offset: int = 3) -> str:
    ...
    return "\n".join([
        ...
        '  Ответ: {"type":"task","title":"зарядить наушники","category":"🏠 Жилье","priority":"Можно потом","deadline":"' + _next_weekday_iso("Вс") + 'T19:00","repeat":"Нет","repeat_time":null,"day_of_week":null,"confidence":"high"}',
