...
def build_system(tz_offset: int = 3) -> str:
    ...
    return "\n".join([
        ...
        "  🔴 Срочно: явные слова 'срочно/немедленно/сейчас/asap', дедлайн сегодня",
        "  🟡 Важно: здоровье (врач, лекарства, анализы), деньги (оплата, долг, счёт), работа, документы, дедлайн скоро (1-3 дня), продукты, обычные покупки, рутинные дела",
        "  ⚪ Можно потом: бытовые мелочи (выкинуть, убрать, погладить кота), развлечения, 'когда-нибудь', 'как-нибудь'",
        "Примеры: 'записаться к врачу'→Важно, 'оплатить квартиру'→Важно, 'купить сметану'→Важно, 'выкинуть салфетки'→Можно потом, 'срочно позвонить маме'→Срочно, 'погладить кота'→Можно потом, 'купить корм коту'→Важно, 'сдать документы в налоговую'→Важно",
        "",
